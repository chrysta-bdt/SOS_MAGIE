...
service9 = Service.create!(name: 'Augmentation de libido', category: 'love',
                          description: "Notre duo de rituel et concoction magique vous garantie de résoudre tous vos soucis lié à votre sexualité (troubles de sexualité, l'impuissance sexuelle, la frigidité ou l'éjaculation précoce)(Efficacité: instantané)",
...
service10 = Service.create!(name: "Mariage spirituel", category: 'love',
                          description: "Officialisé par HARRY POTTER, ce rituel de mariage comblera les couples voulant s'unir aux forces de la nature pendant leur cérémonie enchanté..",
